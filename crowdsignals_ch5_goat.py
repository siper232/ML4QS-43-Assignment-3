...
def main():
    ...
    DATASET_FNAME = 'chapter4_result_goat.csv'
    RESULT_FNAME = 'chapter5_result_goat.csv'
    ...
    if FLAGS.mode == 'kmeans':
        ...
        DataViz.plot_clusters_3d(dataset_cluster, [
    ...
    if FLAGS.mode == 'final':
        ...
        dataset = clusteringNH.k_means_over_instances(dataset, ['ax', 'ay', 'az'], FLAGS.k, 'default', 50, 50)
        DataViz.plot_clusters_3d(dataset, ['ax', 'ay', 'az'], 'cluster', ['label'])
        DataViz.plot_silhouette(dataset, 'cluster', 'silhouette')
        util.print_latex_statistics_clusters(
            dataset, 'cluster', ['ax', 'ay', 'az'], 'label')
